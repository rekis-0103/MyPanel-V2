...
describe('FileManager', () => {
  it('renders the table and exposes file management operations', async () => {
    ...
    expect(screen.getByRole('button', { name: 'Folder Baru' })).toBeEnabled();
    fireEvent.click(screen.getByRole('button', { name: 'Aksi server.properties' }));
    expect(screen.getByRole('button', { name: 'Ganti nama' })).toBeEnabled();
  });
